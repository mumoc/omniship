...
class UPSTest < Minitest::Test
  ...
  def test_tracking_info
    ...
    assert_equal shipment_info.class, String
  end
  ...
  def test_validate_address
     response = @carrier.validate_address('BEVERLY HILLS','CA','90210','US',{:test => true, :key => "#TODO",:login => '#TODO', :password => "#TODO", :origin_account => "#TODO"})
